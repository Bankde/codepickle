...
class SimpleModuleTest(unittest.TestCase):
    ...
    def test_simple(self):
        ...
        pickled, modules = self.benchmarkDump(array_const)
    ...
    def test_sub_simple(self):
        ...
        pickled, modules = self.benchmarkDump(randomIntPlusOne)
        self.assertEqual(len(modules), 1)
        self.assertIn("numpy", modules)
    ...
    def test_sub_duplicate(self):
        ...
        pickled, modules = self.benchmarkDump(testRandom)
        self.assertEqual(len(modules), 1)
        self.assertIn("numpy", modules)
